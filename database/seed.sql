...
-- Evidence Table Seeds (with SHA-256 Hashes)
...
-- Reward Policy Seed (10% reward, max ₹500 cap)
...
-- Offenders Seeds (Masked References, No raw Aadhaar)
...
-- Citizen Rewards Seeds (Fine Paid -> 10% capped at ₹500)
...
-- Mock Government Verification Seeds
